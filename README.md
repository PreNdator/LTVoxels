...
Система работы с вокселями для Unity: генерация мешей на Unity Job System и редактирование чанков без GC-аллокаций, разбиение чанков, сериализация/десериализация данных, импорт .vox (MagicaVoxel). Включает примеры использования и unit-тесты.
